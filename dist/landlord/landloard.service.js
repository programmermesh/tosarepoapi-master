...
var LandlordService = /** @class */ (function () {
    ...
    LandlordService.prototype.showAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var landlord;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.landlordRepository.find()];
                    case 1:
                        landlord = _a.sent();
                        return [2 /*return*/, {
                                users: landlord,
    ...
    LandlordService.prototype.showAllTenantByLandlordId = function (landlordId) {
        return __awaiter(this, void 0, void 0, function () {
            var tenant;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findTenant(landlordId)];
                    case 1:
                        tenant = _a.sent();
                        return [2 /*return*/, {
                                tenants: tenant,
    ...
    LandlordService.prototype.findTenant = function (landlordId) {
        return __awaiter(this, void 0, void 0, function () {
            var tenant;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LandlordService.prototype.createLandlord = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var landlord;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.landlordRepository.save(landlord)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, {
                                landlord: landlord,
    ...
    LandlordService.prototype.updateLandlordById = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            var landlord;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        landlord = _a.sent();
                        return [4 /*yield*/, this.landlordRepository.update(id, data)];
                    case 2:
                        _a.sent();
    ...
    LandlordService.prototype.find = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var landlord;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.landlordRepository.findOne(id)];
                    case 1:
                        landlord = _a.sent();
                        if (!landlord) {
                            throw new common_1.HttpException('Not found', common_1.HttpStatus.NOT_FOUND);
                        }
                        return [2 /*return*/, landlord];
                }
            });
        });
    };
    LandlordService.prototype.deleteLandlordById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var landlord;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        landlord = _a.sent();
                        return [4 /*yield*/, this.landlordRepository.delete(id)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, {
                                resident: landlord,
